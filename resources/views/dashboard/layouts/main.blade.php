    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">SI <sup>Pengaduan</sup></div>
            </a>
            ...
            @can('admin')
            <!-- Nav Item - balasan Menu -->
            <li class="nav-item">
                <a class="nav-link" href="/balasan">
                    <i class="fas fa-fw fa-address-card"></i>
                    <span>Respon Petugas</span></a>
            </li>
            @endcan
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Kelurahan Gunung Panjang 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    @method('post')
                    @csrf
                    <button class="btn btn-primary" type="submit"><i class="fas fa-sm fa-fw fa-user-slash text-white-50"></i>Logout</button>
                    </form>
                </div>
            </div>
        </div>
